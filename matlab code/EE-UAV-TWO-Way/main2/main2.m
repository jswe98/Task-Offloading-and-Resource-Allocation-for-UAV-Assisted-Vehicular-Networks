...
clear
% 总初始化
T=60; M=4;H=100; det=1;roadwidth=30;roadlength=800; %共有70个时隙 %solt length   TTT=T*det;%time span
VUAV_max=20;%无人机速度约束
W=10^(6);
...
legend_entries{M+2} = 'UAV Trajectory';
legend_entries{M+3} = '黄色双实线';
% legend_entries{M+3} = '向右为正方向';
%legend_entries{M+4} = 'UAV Trajectory';
