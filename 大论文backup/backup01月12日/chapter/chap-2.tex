...
\text { s.t. }
& R_{n}\{p_n(c_{n})\} \geq c_{n} p_n(c_{n}) g_{n,0}           \tag{\ref{E2-12}{-1}}      \label{E2-12-1}\\  %信噪比中断概率约束
& 0\leq c_n\leq c_{n,\textrm{max}}                           \tag{\ref{E2-12}{-2}}      \label{E2-12-2}  %功率阈值
\end{align}
...
\text { s.t. }
& \frac{-\gamma_{th} I_{n}}{\ln(1-\varepsilon)}-p_n g_{n,n}\leq0          \tag{\ref{E2-17}{-1}}      \label{E2-17-1}\\  %信噪比中断概率约束
& 0\leq p_n\leq p_{n,\textrm{max}}                                        \tag{\ref{E2-17}{-2}}      \label{E2-17-2}  %功率阈值
\end{align}
...
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//chap2//2.eps}
\caption{功率收敛性能}
\label{F2}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//chap2//3.eps}
\caption{价格收敛性能}
\label{F3}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//chap2//4.eps}
\caption{中断概率对此}
\label{F4}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//chap2//5.eps}
\caption{传输速率对比}
\label{F5}
\end{figure}
