...
\section{相关技术的理论基础}\label{section2-1}
...
\section{相关优化理论概述}\label{section2-2}
\subsection{凸优化理论}\label{section2-2-1}
...
\begin{figure}[hptb!]
 ...
 \end{figure}
\end{verbatim}
\subsection{博弈论}\label{section2-2-1}
