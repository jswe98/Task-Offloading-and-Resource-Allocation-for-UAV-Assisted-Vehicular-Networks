...
\entitle{RESEARCH OF JOINT OPTIMAL ALLOCATION OF
COMMUNICATION RESOURCES FOR VEHICLE NETWORKING IN
HIGHLY DYNAMIC ENVIRONMENTS}                      % 英文题目，所有字母大写！！！
\enauthor{Wei Jianshuai}                          % 作者英文姓名，注意：姓在前，名在后！！！
\enadvisor{Professor}                  % 导师英文姓名，注意：姓在前，名在后，若是“副教授”，加上“Associate” 词！！！
\enadvisorname{ Liu Zhixin}
...
\zihao{-2}{\heiti 指导教师} & \zihao{-2}{\kaishu\CAST@value@advisornamecn\textcolor[RGB]{255,0,0}{\CAST@value@advisor}}
\end{tabular}\\
\vspace*{2cm}
%\zihao{-2}\songti\textbf{2024 年6月}%%%第一页上的日期，根据实际答辩时间填写，  mzhy55
\zihao{-2}\songti{2024年\textcolor[RGB]{255,0,0}{6}月}%%%第一页上的日期，根据实际答辩时间填写，  mzhy55
\end{center}
\clearpage
\if@twoside
\thispagestyle{empty}
