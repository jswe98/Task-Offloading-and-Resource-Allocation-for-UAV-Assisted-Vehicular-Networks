...
\entitle{RESEARCH ON TASK OFFLOADING AND RESOURCE ALLOCATION FOR UAV-ASSISTED VEHICULAR NETWORKS}                      % 英文题目，所有字母大写！！！
...
\zihao{-2}{\heiti 指导教师} & \zihao{-2}{\kaishu\CAST@value@advisornamecn\textcolor[RGB]{255,0,0}{\CAST@value@advisor}} %第一页添加了教授
\end{tabular}\\
\vspace*{2cm}
