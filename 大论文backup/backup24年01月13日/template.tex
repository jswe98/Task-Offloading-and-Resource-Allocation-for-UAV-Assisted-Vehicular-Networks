...
\begin{comment}
占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改
\end{comment}
...
\classification{O226}                             % 中图分类号，注意，此项要自己查，更改！！！
\UDC{517}                                         % UDC，注意，此项要自己查，更改！！！
%\title{高动态环境下车联网通信资源联合优化分配的研究}                          % 论文题目
\title{无人机辅助的车联网络任务卸载与资源分配研究}                          % 论文题目
\author{魏建帅}                                   % 作者姓名，注意：姓在前，名在后！！！
\advisor{刘志新\, 教授}                           % 导师姓名，注意：姓在前，名在后，若是“副教授”，加上“副”字！！！
\degree{工学硕士}                                 % 申请学位
...
\entitle{RESEARCH OF JOINT OPTIMAL ALLOCATION OF COMMUNICATION RESOURCES FOR VEHICLE NETWORKING IN HIGHLY DYNAMIC ENVIRONMENTS}         % 英文题目，所有字母大写！！！
\enauthor{Wei Jianshuai}                              % 作者英文姓名，注意：姓在前，名在后！！！
\enadvisor{Professor Liu Zhixin}                    % 导师英文姓名，注意：姓在前，名在后，若是“副教授”，加上“Associate”词！！！
\enschool{School of Electrical Engineering, Yanshan University}                        % 院校英文名称
\enathdate{June, 2024}                                % 英文答辩日期，注意：要依实际答辩时间修改！！！
...
\end{tabular}\\
\vspace*{2cm}
\zihao{-2}\songti\textbf{2023 年6月}%%%第一页上的日期，根据实际答辩时间填写，  mzhy55
\end{center}
\clearpage
\if@twoside
\thispagestyle{empty}
...
\end{thebibliography}占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改占位符勿修改
\end{comment}
