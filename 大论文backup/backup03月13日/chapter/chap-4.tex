...
\varepsilon_3, \forall m,t                                               \tag{\ref{E4-13}{-1}}      \label{E4-13-1}\\  %信噪比中断概率约束
...
首先，我们展示了不同时隙下的系统总能效最大时的无人机轨迹优化，其中黑色箭头代表车辆向右行驶为正方向，我们规定无人机从固定起点飞行至固定终点，
