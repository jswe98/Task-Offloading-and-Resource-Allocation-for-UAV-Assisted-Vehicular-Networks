...
for programmatic =2  ;thetatheta=1; 
...
Total_thetaSUM=sum(Total_theta, 2)

figure;
indices = [1,2,3,4,5,6,7]; 
hold on;
plot(Total_thetaSUM, '-sr', 'LineWidth', 1.5); 
plot( Total_thetaSUM, '-sr', 'LineWidth', 1.5); 
plot(EE_total_recod, '-sb', 'LineWidth', 1.5);  
