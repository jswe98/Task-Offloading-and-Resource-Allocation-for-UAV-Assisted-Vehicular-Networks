function [GVR,GVU,distanceVR,distanceVU,CARposition,L] = CARinfo(H,T,M,det,roadlength,roadwidth,UAVcvx,programmatic,thetatheta,BCDl)
...
save('cardatatemp1.mat', 'Vposition'); 

if programmatic == 1 && BCDl == 1 && thetatheta== 1
    1;
else
Varin2=load('cardatatemp1.mat');
Vposition = Varin2.Vposition;  %调用了之前的数据S
end
    
% 
Varin=load ('cardatatemp100.mat');%这两行都要一起用，其中CARposition是默认的不能改动
