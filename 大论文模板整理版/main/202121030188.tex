...
\hypersetup{hypertex=true,
            colorlinks=true,
            linkcolor=blue,     %blue    公式与图与目录
            anchorcolor=black,
            citecolor=green}    %green  参考文献
...
\entitle{Research on Task Offloading and
...
\zihao{-2}{\heiti 指导教师} & \zihao{-2}{\kaishu\CAST@value@advisornamecn\quad\textcolor[RGB]{255,0,0}{\CAST@value@advisor}} %第一页添加了教授
\end{tabular}\\
\vspace*{2cm}
...
\input{../chapter/chap-2}
\input{../chapter/chap-3}
\input{../chapter/chap-4}
\input{../chapter/chap-5}
