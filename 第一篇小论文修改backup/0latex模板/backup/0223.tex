...
The remainder of this article is organized as follows: the model of power control and task offloading for cloud assisted MEC in vehicular networks is established de?nes in Section II. In Section III, the probability constraints and the objective function of the primal problem are formulated, and the optimization is proposed. In Section IV, simulation results and performance analysis are presented. Finally, we draw a conclusion in Section V.
