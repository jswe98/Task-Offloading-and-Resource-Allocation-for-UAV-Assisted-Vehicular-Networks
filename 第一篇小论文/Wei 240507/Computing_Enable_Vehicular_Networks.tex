...
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//diff_dup.eps}  %diff_dup.eps
\caption{Comparison of average system utility with different task input sizes $d_u$.}
\label{F8}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//diff_total.eps}  %diff_total.eps
\caption{Comparison for average system utility with different $f_{total}$.}
\label{F9}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//diff_c.eps}  %diff_c.eps
