...
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//model22-eps-converted-to.pdf}  %model22.eps
...
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//pp-eps-converted-to.pdf} %pp.eps
\caption{Power convergence performance.}
\label{F2}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//ff-eps-converted-to.pdf}  %ff.eps
\caption{Computational resource of cloud allocation to RSU.}
\label{F3}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//ee-eps-converted-to.pdf}  %ee.eps
...
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//diffspeed1-eps-converted-to.pdf}  %diffspeed1.eps
...
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//diff_e1-eps-converted-to.pdf}  %diff_e1.eps
...
\item[2)]``“Without vehicle power control''(denoted as ``Without-VPC''), the transmit power of the vehicles is set as the average power during the offloading \cite{LiTvT2024}.
...
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//compare-eps-converted-to.pdf}  %compare.eps
...
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//diff_dup-eps-converted-to.pdf}  %diff_dup.eps
\caption{Comparison of average system utility with different task input sizes $d_u$.}
\label{F8}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//diff_total-eps-converted-to.pdf}  %diff_total.eps
\caption{Comparison for average system utility with different $f_{total}$.}
\label{F9}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=8cm]{figures//diff_c-eps-converted-to.pdf}  %diff_c.eps
