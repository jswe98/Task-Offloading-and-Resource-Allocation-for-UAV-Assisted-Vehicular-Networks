...
\hypersetup{hypertex=true,
            colorlinks=true,
            linkcolor=black,     %blue    公式与图与目录 颜色
            anchorcolor=black,
            citecolor=black}    %green  参考文献颜色
...
\title{生物融合式康复机构理论与应用研究}                                                                    % 论文中文题目
\author{姓在前名在后}                                   % 作者姓名，注意：姓在前，名在后！！！
\advisornamecn{导师}                           % 导师姓名，注意：姓在前，名在后，若是“副教授”，加上“副”字！！！
\advisor{ 教授}
\degree{工学硕士}                                 % 申请学位
...
\entitle{BIO-Syncretic Rehabilitation Mechanism Theory and Application}                                       % 英文题目，首字母大写！！！
\enauthor{Zhang Name}                          % 作者英文姓名，注意：姓在前，名在后！！！
\enadvisor{Professor}                  % 导师英文姓名，注意：姓在前，名在后，若是“副教授”，加上“Associate” 词！！！
\enadvisorname{ Liu Name}
