...
\title{高动态异构车联网络资源联合鲁棒优化分配的研究}% 论文题目  高动态车联异构网络通信资源联合鲁棒优化分配的研究
\school{燕山大学}                                 % 院校名称
\author{ }  %魏建帅
\advisornamecn{   }     %刘志新                      % 导师姓名，注意：姓在前，名在后，若是“副教授”，加上“副”字！！！
\enauthor{xxx}        %Wei Jianshuai    xxx               % 作者英文姓名，注意：姓在前，名在后！！！
\enadvisorname{ xxx} %Liu Zhixin           xxx
\makeatletter
\hypersetup{
