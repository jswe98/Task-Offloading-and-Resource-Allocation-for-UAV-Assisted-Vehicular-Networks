...
\newcommand{\myenkeywords}{UAV Communication; Throughput Maximisation; Outage Probability; Edge Computing; Trajectory Optimisation; Task Offloading} %
...
\hypersetup{
    ...
    pdfsubject={\CAST@value@school 硕士学位论文},
